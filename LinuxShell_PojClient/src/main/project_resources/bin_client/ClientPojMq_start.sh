...
java $LOGGER_CONFIG -DInputOutputType=MQ -DQueueName=org.ajstark.LinuxShell.input -classpath $CLIENT_LIB:$IN_OUT_LIB:$SLF4:$RABBIT_MQ$SERVER_LIB:$IN_OUT_LIB:$RABBIT_MQ:$LOG4J_API:$LOG4J_CORE   org.ajstark.LinuxShell.ShellClient.PojMqClient
